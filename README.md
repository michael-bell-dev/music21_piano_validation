To run this program, python 3.9+ or higher is required, as well as the Music21 library. Install using pip: pip install music21. To view .musicxml file output, MuseScore should be installed.
